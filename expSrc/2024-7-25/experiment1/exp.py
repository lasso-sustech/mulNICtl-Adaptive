...
fileList = os.listdir('dpScript/2024-7-25/experiment1/NoAda')
txtIndex = 0
...
logger = open(f'dpScript/2024-7-25/experiment1/Adaptive-{target_thru}_Totalthru{totalthru}_2x8x2x{inter_thru}M_149_gap{inter_gap}_TaskNum{taskNum}_{txtIndex}.jsonl', 'w')
...
# # # packet Loss
packetFileName = f"dpScript/2024-7-25/experiment1/PacketLoss/packetLoss{target_thru}_{txtIndex}.txt"
...
packetLoss = ctrller.info_queue.get(block=True, timeout= ctrller.duration + 30)
...
NoAdapath = "dpScript/2024-7-25/experiment1/NoAda"
