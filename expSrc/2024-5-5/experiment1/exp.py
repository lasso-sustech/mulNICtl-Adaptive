...
f       = create_logger_file('expSrc/2024-5-5/experiment1/exp-result.json')
...
for test in range(0, 10):
    ...
    try:
        print( channel_balance_solver.correct_channel_rtt())
    ...
    # if res == header.CHANNEL1:
    #     channel_balance_solver.tx_parts = [0, 0]
    # elif res == header.CHANNEL2:
    #     channel_balance_solver.tx_parts = [1, 1]
    # elif res == header.MUL_CHAN:
    #     channel_balance_solver.load_balance()
    # elif res == None:
    #     pass
    # else:
    #     raise ValueError(f"Unknown switch state {res}")
    
    print(channel_balance_solver.tx_parts)
    channel_balance_solver.apply( proj_stream )
    print(res)
