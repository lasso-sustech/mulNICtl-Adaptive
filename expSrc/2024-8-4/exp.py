...
def create_transmission(trans_manifests, topo, arrivalGap = 16):
    ...
    for name in trans_manifests:
        ...
        # if name == 'file0804_1' or  'file0804_2' or 'file0804_3' or 'file0804_4' or 'file0804_5' or 'file0804_6':########################################################
...
fileList = os.listdir('dpScript/2024-8-4/rtt/')
txtIndex = 0
...
topo,links        = construct_graph("./config/topo/2024-8-4.txt")
# print("topo: ", topo)
...
logger1 = open(f'dpScript/2024-8-4/TaskAll_{txtIndex}.jsonl', 'w')
logger2 = open(f'dpScript/2024-8-4/Qos_{txtIndex}.jsonl', 'w')
...
def datatransfer():
    ...
    while zeroIndex < 10:
        ...
        plt.pause(0.01)
        index += 1
        plt.savefig(f"dpScript/2024-8-4/rtt_{txtIndex}.png")  
    plt.ioff()
    # plt.close()
