...
fileList = os.listdir('dpScript/2024-7-24/experiment2/NoAda')
txtIndex = 0
...
taskNum = 6  #stream number
interNum = 8  #interference number
inter_gap = 1  #interference packetage gap
# txtIndex = 58
target_thru = 20
totalthru = 400
# for target_thru in thru_list:
inter_thru = int((totalthru - target_thru*taskNum)/(interNum*2))
topo        = construct_graph("./config/topo/2024-7-24.txt")
intertos = 96
...
logger = open(f'dpScript/2024-7-24/experiment2/Adaptive-{target_thru}_Totalthru{totalthru}_2x8x2x{inter_thru}M_149_gap{inter_gap}_TaskNum{taskNum}_{txtIndex}.jsonl', 'w')

def get_statistics(logger):
    base_info = ctl.graph_qos_collections(topo)
    exp_solver = solver.Controller()
    time.sleep(2) 
    for i in range(30): #ctl Num
...
# # # packet Loss
packetFileName = f"dpScript/2024-7-24/experiment2/PacketLoss/packetLoss{target_thru}_{txtIndex}.txt"
...
targetIP = "192.168.3.72"
NoAdapath = "dpScript/2024-7-24/experiment2/NoAda"
Adapath = "dpScript/2024-7-24/experiment2/Ada"
...
for port in portlist:
    ...
    time.sleep(5)
# ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-24/experiment2/NoAda", "../stream-replay/logs/rtt-6205*128.txt" , links[0])
# time.sleep(5)
# ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-24/experiment2/NoAda", "../stream-replay/logs/rtt-6206*128.txt" , links[2])
# time.sleep(5)
# ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-24/experiment2/NoAda", "../stream-replay/logs/rtt-6207*128.txt" , links[0])
# time.sleep(5)
# ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-24/experiment2/NoAda", "../stream-replay/logs/rtt-6208*128.txt" , links[2])
# time.sleep(5)
# ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-24/experiment2/NoAda", "../stream-replay/logs/rtt-6209*128.txt" , links[0])
# time.sleep(5)
# ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-24/experiment2/NoAda", "../stream-replay/logs/rtt-6210*128.txt" , links[2])
# time.sleep(5)
# ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-24/experiment2/NoAda", "../stream-replay/logs/rtt-6211*128.txt" , links[0])
# time.sleep(5)
# ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-24/experiment2/NoAda", "../stream-replay/logs/rtt-6212*128.txt" , links[2])
# time.sleep(5)
