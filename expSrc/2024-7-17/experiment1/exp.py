...
topo        = construct_graph("./config/topo/2024-7-17.txt")
...
time.sleep(1)
conn        = ctl.start_transmission_trace_log(graph = topo, DURATION = 100)
...
ctl.fileTransfer(topo, "192.168.3.82", "dpScript/2024-7-17", "../stream-replay/log/output.log", isSend=True)

time.sleep(5)
ctl.fileTransfer(topo, "192.168.3.82",  "dpScript/2024-7-17", "../stream-replay/logs/rtt-6206*128.txt" , isSend=True)

time.sleep(5)
ctl.fileTransfer(topo, "192.168.3.82",  "dpScript/2024-7-17", "../stream-replay/log/rx_output.log" , isSend=False)
