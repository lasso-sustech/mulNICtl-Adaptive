...
inter_thru = int((350 - target_thru*2)/16)
topo        = construct_graph("./config/topo/2024-7-23-2.txt")
...
logger = open(f'dpScript/2024-7-23/experiment2/Adaptive-{target_thru}_cross_2x8x2x{inter_thru}M_149_gap{inter_gap}_{txtIndex}.jsonl', 'w')
...
def get_statistics(logger):
    ...
    for i in range(30): #ctl Num
        ...
        # print("qos ",qos)
        qos.pop('6305@128', None)
        qos.pop('6306@128', None)
        qos.pop('6307@128', None)
        qos.pop('6308@128', None)
        qos.pop('6309@128', None)
        qos.pop('6310@128', None)
        qos.pop('6311@128', None)
        qos.pop('6312@128', None)
        for k in qos:
...
packetFileName = f"dpScript/2024-7-23/experiment2/PacketLoss/packetLoss{target_thru}_{txtIndex}.txt"
...
ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-23/experiment2/NoAda", "../stream-replay/logs/rtt-6205*128.txt" , links[0])
time.sleep(5)
ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-23/experiment2/NoAda", "../stream-replay/logs/rtt-6206*128.txt" , links[2])
time.sleep(5)
...
ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-23/experiment2/Ada", "../stream-replay/logs/rtt-6205*128.txt" , links[0])
time.sleep(10)
ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-23/experiment2/Ada", "../stream-replay/logs/rtt-6206*128.txt" , links[2])
time.sleep(5)
