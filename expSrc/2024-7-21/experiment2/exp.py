...
# thru_list = [50]
txparts_list = [0,0.2,0.4,0.6,0.8,1]

for target_txparts in txparts_list:

    topo        = construct_graph("./config/topo/2024-7-21.txt")
    ...
    'file1': {
            ...
            'tx_parts'  : [target_txparts, target_txparts],
            'tos'       : 128,
        },
        # 'file2': {
        #     'thru'      : 1,
        ...
        #     'link'      : links[0],
        #     'port'      : 6206,
        #     'links'     : [topo.get_link_ips(links[0])],
        #     'tx_parts'  : [1],
        #     'tos'       : 128,
        # }
    }
    ...
    # ctrller.exp_thread(topo)
    # packet Loss
    packetLoss = ctrller.info_queue.get(block=True, timeout= ctrller.duration + 10)
    packetFileName = f"dpScript/2024-7-21/experiment2/PacketLoss/packetLoss_{target_txparts}_6.txt"
    ...
    ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-21/experiment2/NoAda", "../stream-replay/logs/rtt-6205*128.txt" , isSend=True)
    # print("throughput: ",target_thru)
    print("txparts: ", target_txparts)
    ...
    # logger = open(f'dpScript/2024-7-21/experiment2/Adaptive-{target_thru}_cross_600M_153_6.jsonl', 'w')
    ...
    # # ctrller.exp_thread(topo)
    # AdaPacketLoss = ctrller.info_queue.get(block=True, timeout= ctrller.duration + 10)
    # print(AdaPacketLoss)
    # # packetFile = open(packetFileName,"w")
    ...
    # ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-21/Adaptive/Ada", "../stream-replay/logs/rtt-6205*128.txt" , isSend=True)
