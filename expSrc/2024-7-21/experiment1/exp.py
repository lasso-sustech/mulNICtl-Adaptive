...
for target_thru in thru_list:
    ...
    logger = open(f'dpScript/2024-7-21/Adaptive/Adaptive-{target_thru}_cross_3*2*2*12M*4_149_{txtIndex}.jsonl', 'w')
    ...
    packetFileName = f"dpScript/2024-7-21/Adaptive/PacketLoss/packetLoss{target_thru}_{txtIndex}.txt"
    ...
    ctl.fileTransfer(topo, "192.168.3.72",  "dpScript/2024-7-21/Adaptive/NoAda", "../stream-replay/logs/rtt-6205*128.txt" , isSend=True)
