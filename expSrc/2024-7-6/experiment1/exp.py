...
trans_manifests = {
    ...
    #     'link'      : links[0],
    #     'port'      : 6205,
    #     'links'     : [topo.get_link_ips(links[1])],
    #     'tx_parts'  : [0],
    #     'tos'       : 96,
    # },
    'file2': {
...
time.sleep(1)
conn        = ctl.start_transmission_trace_log(graph = topo, DURATION = 10)
...
ctl.fileTransfer(topo, "192.168.3.82", "test", is_sender=True)

time.sleep(5)
ctl.fileTransfer(topo, "192.168.3.82", "test", is_sender=False)
