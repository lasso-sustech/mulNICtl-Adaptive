...
fileList = os.listdir('dpScript/2024-8-6/rtt/')
txtIndex = 0
...
topo,links        = construct_graph("./config/topo/2024-8-6.txt")
# print("topo: ", topo)
...
trans_manifests = {
    ...
    #     'link'      : links[2],
    #     'port'      : 6209,
    #     'links'     : [topo.get_link_ips(links[2]),topo.get_link_ips(links[2])],
    #     'tx_parts'  : [1,1],
    #     'tos'       : 128,
    #     'channels'  : [constHead.CHANNEL0, constHead.CHANNEL1],
    # },
    ...
    #     'link'      : links[3],
    #     'port'      : 6210,
    #     'links'     : [topo.get_link_ips(links[3]),topo.get_link_ips(links[3])],
    #     'tx_parts'  : [1,1],
    #     'tos'       : 128,
    #     'channels'  : [constHead.CHANNEL0, constHead.CHANNEL1],
    # },
    '0806testfile100_3': {
        ...
        'link'      : links[4],
        'port'      : 6211,
        'links'     : [topo.get_link_ips(links[4]),topo.get_link_ips(links[4])],
        'tx_parts'  : [1,1],
        'tos'       : 96,
        'channels'  : [constHead.CHANNEL0, constHead.CHANNEL1],
    },
    '0806testfile100_4': {
        ...
        'link'      : links[5],
        'port'      : 6212,
        'links'     : [topo.get_link_ips(links[5]),topo.get_link_ips(links[5])],
        'tx_parts'  : [1,1],
        'tos'       : 96,
        'channels'  : [constHead.CHANNEL0, constHead.CHANNEL1],
    },
...
logger1 = open(f'dpScript/2024-8-6/TaskAll_{txtIndex}.jsonl', 'w')
logger2 = open(f'dpScript/2024-8-6/Qos_{txtIndex}.jsonl', 'w')
...
def datatransfer():
    ...
    data_idx = 0
    portlist = ["6209@128","6210@128","6211@96","6212@96","6213@128","6214@128","6215@96","6216@96","6217@128","6218@128","6219@128","6220@128"]###############################################
    while zeroIndex < 10:
        ...
        plt.pause(0.01)
        index += 1
        plt.savefig(f"dpScript/2024-8-6/rtt_{txtIndex}.png")  
    plt.ioff()
    # plt.close()
...
rt.plot_rtt_stuttering(temptxtName,taskRttlist,Stutteringlist,part = 1)
