...
def main():
    ...
    #     print(fileName)
    index = 3
    fileName_noada = f"./Adaptive/NoAda/output{index}.txt"
    rttSinglePlot_cdf(fileName_noada)
    rttSinglePlot_time(fileName_noada)
    
    ## multi-channel
    fileName = f"./Adaptive/Ada/output{index}.txt"
    rttArray= txtRead_multiChannel(fileName)
    ...
    #         fileName = filePath + "output"+str(idx_loop)+".txt"
    #         print(fileName)
    #         rttArraySinglePlot_cdf(fileName)
    #         rttArraySinglePlot_time(fileName)
